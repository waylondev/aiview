...
type Client interface {
	...
	SearchVideo(keyword string, page int, order string, duration int, tid int) ([]SearchVideoResult, error)
	SearchUser(keyword string, page int) ([]SearchUserResult, error)
	GetUserInfo(uid int) (*UserInfo, error)
	GetUserVideos(uid int, count int, order string, tid int, keyword string) ([]VideoInfo, error)
	GetHotVideos(page int, count int) ([]VideoInfo, error)
	GetRankVideos(rid int, day int, typeStr string) ([]VideoInfo, error)
	GetFavoriteList(uid int, page int) ([]FavoriteFolder, error)
